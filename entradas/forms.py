...
class entradas_reserva_form(forms.ModelForm):
    class Meta:
        ...
        fields = ['nome', 'apelidos', 'correo_electrónico_entradas', 'correo_electrónico_entradas_repetido', 'numero_entradas']
...
#O attrs é CSS style
        widgets = {
            ...
            'correo_electrónico_entradas_repetido': forms.TextInput (attrs = {'class': 'form-control'}),
