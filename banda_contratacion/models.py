...
class contratacion_datos(models.Model):
    ...
    Advertencia = models.BooleanField('solista', default=False, validators=[conxunto_validation, enviar_mensaxe_error, limpiar_lista])
    ...
    nome_contratante = models.CharField(blank=False, max_length=255)
    telefono = models.IntegerField(validators=[telephone_number_validation])
    email_contratante = models.EmailField(blank=False, max_length=255, validators=[email_validation_contratacion])
